...
contract SudoPairTest is Test {
    ...
    function setUp() public {
        ...
        SudoFactory factory = new SudoFactory();
...
contract TestUser {
    function provideLiquidity(
        ...
        SudoPair(pairAddress_).mint(address(this));
    }
    ...
    function removeLiquidity(address pairAddress_) public {
        ...
        SudoPair(pairAddress_).burn(address(this));
    }
}
