...
import "./interfaces/ISudoCallee.sol";
...
contract SudoPair is ERC20, Math {
    ...
    constructor() ERC20("Sudo Pair", "ZUNIV2", 18) {}
    ...
    function swap(
        ...
        if (data.length > 0)
            ISudoCallee(to).sudoCall(msg.sender, amount0Out, amount1Out, data);
